...
{
	const int CurrentChunkCoordX = FMath::RoundToInt(Viewer->GetActorLocation().X / ChunkSize);
	const int CurrentChunkCoordY = FMath::RoundToInt(Viewer->GetActorLocation().Y / ChunkSize);
